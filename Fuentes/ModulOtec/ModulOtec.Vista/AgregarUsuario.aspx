    ...
    <table class="espacio-tabla table-responsive">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList runat="server" ID="ddlRegion" required="required" AutoPostBack="True" OnSelectedIndexChanged="RegionSelectedIndexChanged"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:DropDownList runat="server" ID="ddlProvincia" required="required" AutoPostBack="True" OnSelectedIndexChanged="ProvinciaSelectedIndexChanged"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td colspan="2" align="center">
                    ...
                    <asp:Button runat="server" ID="btnAgregarUsuario" Text="Agregar Usuario" type="submit" CssClass="btn btn-success" OnClick="AgregarUsuarioClick"></asp:Button>
                </td>
            </tr>
        </tbody>
    </table>
